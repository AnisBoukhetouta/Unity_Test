...
namespace MalbersAnimations.Controller
{
    ...
    public class LedgeGrab : State
    {
        ...
        public override void TryExitState(float DeltaTime)
        {
            ...
            {
                Debug.LogError($"Exception in LedgeGrab.TryExitState: {ex.Message}\n{ex.StackTrace}");
                AllowExit(); // Force the state to exit
                animal.State_Activate(StateEnum.Idle); // Transition to a fallback state (e.g., Idle or Locomotion)
            }
        }
