    ...
    public class MPickUp : MonoBehaviour, IAnimatorListener
    {
        ...
        public void PickUpItem()
        {
            ...
            if (Item)
            {
                ...
                Proxy.ResetTrigger();
                /*if (transform.parent.tra.GetComponent<PhotonView>().IsMine)
                {
                    transform.parent.transform.parent.GetComponent<PhotonView>().RPC("SyncPickupItem", RpcTarget.Others, Item.gameObject);
                }*/
            }
        }
